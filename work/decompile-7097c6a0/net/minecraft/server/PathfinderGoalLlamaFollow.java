...
public class PathfinderGoalLlamaFollow extends PathfinderGoal {
    ...
    public boolean a() {
        if (!this.a.isLeashed() && !this.a.eJ()) {
            ...
            while (iterator.hasNext()) {
                ...
                if (entityllama1.eJ() && !entityllama1.eI()) {
            ...
            if (entityllama == null) {
                ...
                while (iterator.hasNext()) {
                    entity = (Entity) iterator.next();
                    entityllama1 = (EntityLlama) entity;
                    if (entityllama1.isLeashed() && !entityllama1.eI()) {
                        d1 = this.a.h((Entity) entityllama1);
                        if (d1 <= d0) {
                            d0 = d1;
                            entityllama = entityllama1;
    ...
    public void e() {
        if (this.a.eJ()) {
            EntityLlama entityllama = this.a.eK();
    ...
    private boolean a(EntityLlama entityllama, int i) {
        if (i > 8) {
            return false;
        } else if (entityllama.eJ()) {
            if (entityllama.eK().isLeashed()) {
                return true;
            } else {
                EntityLlama entityllama1 = entityllama.eK();
