...
public enum ReputationType {
    ...
    MAJOR_NEGATIVE("major_negative", -5, 100, 10, 10), MINOR_NEGATIVE("minor_negative", -1, 200, 20, 20), MINOR_POSITIVE("minor_positive", 1, 200, 10, 20), MAJOR_POSITIVE("major_positive", 5, 100, 5, 10), TRADING("trading", 1, 25, 2, 20);
